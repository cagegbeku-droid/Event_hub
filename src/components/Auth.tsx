      ...
      <div className="bg-gray-900 rounded-lg max-w-md w-full p-6 relative">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full mt-4 bg-white hover:bg-gray-100 text-gray-900 font-semibold py-2 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            <GoogleIcon />
